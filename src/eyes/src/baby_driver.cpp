...
private: 
    ...
    ros::Subscriber Stick; // camera subscriber
    ros::Subscriber Rope;  // lidar subscriber

public: 

    // Constructor
    BabyDriver() {
        Stick = bill.subscribe("cameron", 1000, chatterCallBackCamera);
        Rope = bill.subscribe("larry", 1000, chatterCallBackLidar);
